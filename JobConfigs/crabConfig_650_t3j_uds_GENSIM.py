...
config.General.requestName = 'rpv_stop_650_t3j_uds'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'rpv_stop_650_t3j_uds_py_LHE_GEN_SIM.py'
config.JobType.allowUndistributedCMSSW = True

config.section_("Data")
# config.Data.primaryDataset = 'MinBias'
config.Data.outputPrimaryDataset = 'rpv_stop_650_t3j_uds_GENSIM'
...
config.Data.outputDatasetTag = 'rpv_stop_650_t3j_uds'
