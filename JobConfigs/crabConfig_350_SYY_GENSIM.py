...
config.General.requestName = 'stealth_stop_350_singlino_SYY'
...
config.Data.outputPrimaryDataset = 'stealth_stop_350_singlino_SYY_GENSIM'
...
config.Data.outputDatasetTag = 'stealth_stop_350_singlino_SYY'
