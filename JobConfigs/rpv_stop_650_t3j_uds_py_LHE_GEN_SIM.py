...
# with command line options: Configuration/GenProduction/python/rpv_stop_650_t3j_uds.py --fileout file:rpv_stop_650_t3j_uds_GENSIM.root --mc --eventcontent RAWSIM,LHE --era Run2_25ns --datatier GEN-SIM,LHE --conditions auto:run2_mc --beamspot Realistic50ns13TeVCollision --step LHE,GEN,SIM --magField 38T_PostLS1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/rpv_stop_650_t3j_uds.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:rpv_stop_650_t3j_uds_GENSIM.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('file:rpv_stop_650_t3j_uds_GENSIM_inLHE.root'),
