...
# with command line options: Configuration/GenProduction/python/stealth_stop_650_singlino_SHuHd.py --fileout file:stealth_stop_650_singlino_SHuHd_GENSIM.root --mc --eventcontent RAWSIM,LHE --era Run2_25ns --datatier GEN-SIM,LHE --conditions auto:run2_mc --beamspot Realistic50ns13TeVCollision --step LHE,GEN,SIM --magField 38T_PostLS1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/stealth_stop_650_singlino_SHuHd.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:stealth_stop_650_singlino_SHuHd_GENSIM.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('file:stealth_stop_650_singlino_SHuHd_GENSIM_inLHE.root'),
