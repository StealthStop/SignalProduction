...
# with command line options: step1 --filein file:stealth_stop_350_singlino_SYY_AOD.root --fileout file:stealth_stop_350_singlino_SYY_MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:stealth_stop_350_singlino_SYY_AOD.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:stealth_stop_350_singlino_SYY_MINIAOD.root'),
